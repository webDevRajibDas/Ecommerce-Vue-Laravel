    ...
    <div class="container my-4">
        <div class="row py-5">
            <div class="col-md-5 col-lg-3 mb-5 mb-lg-0">
                ...
                <p class="text-5 mb-0">Email: <a href="mailto:info@porto.com">info@hellob2b.com</a></p>
            </div>
            <div class="col-md-7 col-lg-5 mb-5 mb-lg-0">
                <h5 class="text-6 text-transform-none font-weight-semibold text-color-light mb-4">Pages</h5>
                <div class="row">
                    <div class="col-6">
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Call to Action</a></p>
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Pricing Tables</a></p>
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Word Rotator</a></p>
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Tooltips & Popovers</a></p>
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Sticky Elements</a></p>
                    </div>
                    <div class="col-6">
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Progress Bars</a></p>
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Sections & Parallax</a></p>
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Lists</a></p>
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Image Frames</a></p>
                        <p class="mb-1"><a href="#" class="text-4 link-hover-style-1">Testimonials</a></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
