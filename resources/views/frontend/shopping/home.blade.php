...
<div class="page-wrapper">
                    ...
                    <div class="header-search header-search-popup header-search-category d-none d-lg-block ml-xl-5">
                        ...
                        <form action="#" method="get">
                            <div class="header-search-wrapper">
                                <input type="search" class="form-control bg-white" name="q" id="q" placeholder="I'm searching for..." required="">
    ...
    <main class="main">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-2">
                        <div class="home-banner banner banner1 banner-md-vw banner-sm-vw d-flex align-items-center">
                            <figure class="w-100">
                                <img src="assets/images/demoes/demo7/banners/banner-1.jpg" style="background-color: #4a4a4a;" alt="banner">
                            </figure>
                            <div class="banner-layer">
                                <h4 class=" text-white mb-0">Find the Boundaries</h4>
                                <h2 class="text-white mb-0">Flash Sale</h2>
                                ...
                                <a href="demo7-shop.html" class="btn bg-white btn-md ls-10">Shop Now!</a>
                            </div>
                            <!-- End .banner-layer -->
                        </div>
                        <!-- End .home-slide -->
                        ...
                        <div class="row h-100">
                            <div class="col-lg-12 mb-2">
                                <div class="banner banner2 banner-hover-shadow d-flex align-items-center">
                                    <figure class="w-100">
                                        <img src="assets/images/demoes/demo7/banners/banner-2.jpg" style="background-color: #ccc;" alt="banner">
                                    </figure>
                                    <div class="banner-layer">
                                        <h3 class="m-b-2">Porto Watches</h3>
                                        <h4 class="m-b-2 text-secondary"><sup class="text-dark"><del>20%</del></sup>30%<sup>OFF</sup></h4>
                                        <a href="demo7-shop.html" class="btn btn-dark text-uppercase ls-10">Shop
                                            Now</a>
                                        <img src="assets/images/demoes/demo7/banners/brand-sm.png" style="background-color: #eee;" width="48" height="15" alt="brand" />
                                    </div>
                                </div>
                                <!-- End .banner -->
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="banner banner3 text-uppercase banner-hover-shadow d-flex align-items-center">
                                    ...
                                    <h6 class="banner-label left-label">50<small><sup>%</sup><sub>OFF</sub></small>
                                    </h6>
                                    <h6 class="banner-label right-label">70<small><sup>%</sup><sub>OFF</sub></small>
                                    </h6>
                                    <h6 class="banner-label bottom-label mb-0">
                                    ...
                                    <div class="banner-layer banner-layer-middle text-center">
                                        ...
                                        <a href="demo7-shop.html" class="btn btn-dark btn-black ls-10">SHOP NOW</a>
                                    </div>
                                </div>
                                <!-- End .banner -->
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 mb-2">
                        <div class="banner banner4 text-uppercase banner-hover-shadow d-flex align-items-center">
                            <figure class="w-100">
                                <img src="assets/images/demoes/demo7/banners/banner-4.jpg" style="background-color: #555;" alt="banner">
                            </figure>
                            ...
                            <div class="banner-layer banner-layer-middle d-flex align-items-end flex-column">
                                <div class="coupon-sale-content">
                                    ...
                                    <a href="demo7-shop.html" class="btn bg-white btn-lg ls-10 d-block d-lg-inline-block  text-dark">Get
                                        Yours!</a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="featured-products-section appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="100">
                ...
                <div class="owl-carousel owl-theme dots-top dots-small" data-owl-options="{
                    ...
                    <div class="product-default left-details">
                        <figure>
                            <a href="demo7-product.html">
                                <img src="assets/images/demoes/demo7/products/product-8.jpg" alt="product" width="300" height="300">
                                <img src="assets/images/demoes/demo7/products/product-8-2.jpg" alt="product" width="300" height="300">
                            </a>
                            <div class="label-group">
                                <span class="product-label label-hot">HOT</span>
                                <span class="product-label label-sale">-15%</span>
        ...
        <div class="categories-section bg-primary">
            <div class="container">
                <h2 class="section-title border-0 title-decorate text-center text-white d-flex align-items-center appear-animate" data-animation-name="fadeInUpShorter">
                        <span>BROWSE
                            OUR
                            CATEGORIES</span></h2>
                <div class="owl-carousel owl-theme appear-animate show-nav-hover" data-animation-name="fadeInUpShorter" data-animation-delay="200" data-owl-options="{
                        'dots': false,
                        'margin': 20,
                        'loop': false,
        ...
        <div class="container">
            <div class="product-widgets row pb-2 appear-animate" data-animation-name="fadeIn" data-animation-delay="100">
                <div class="col-md-4 col-sm-6 pb-5">
                    ...
                    <div class="product-default left-details product-widget mb-2">
                        <figure>
                            <a href="demo7-product.html">
                                <img src="assets/images/demoes/demo7/products/product-2.jpg" width="175" height="175" alt="product" />
                                <img src="assets/images/demoes/demo7/products/product-2-2.jpg" width="175" height="175" alt="product" />
                            </a>
                        </figure>
                        <div class="product-details">
                            <div class="category-list">
                    ...
                    <div class="product-default left-details product-widget mb-2">
                        <figure>
                            <a href="demo7-product.html">
                                <img src="assets/images/demoes/demo7/products/product-7.jpg" width="175" height="175" alt="product" />
                                <img src="assets/images/demoes/demo7/products/product-7-2.jpg" width="175" height="175" alt="product" />
                            </a>
                        </figure>
                        <div class="product-details">
                            <div class="category-list">
                    ...
                    <div class="product-default left-details product-widget mb-2">
                        <figure>
                            <a href="demo7-product.html">
                                <img src="assets/images/demoes/demo7/products/product-13.jpg" width="175" height="175" alt="product" />
                                <img src="assets/images/demoes/demo7/products/product-13-2.jpg" width="175" height="175" alt="product" />
                            </a>
                        </figure>
                        <div class="product-details">
                            <div class="category-list">
                ...
                <div class="col-md-4 col-sm-6 pb-5">
                    ...
                    <div class="product-default left-details product-widget mb-2">
                        <figure>
                            <a href="demo7-product.html">
                                <img src="assets/images/demoes/demo7/products/product-3.jpg" width="175" height="175" alt="product" />
                                <img src="assets/images/demoes/demo7/products/product-3-2.jpg" width="175" height="175" alt="product" />
                            </a>
                        </figure>
                        <div class="product-details">
                            <div class="category-list">
                    ...
                    <div class="product-default left-details product-widget mb-2">
                        <figure>
                            <a href="demo7-product.html">
                                <img src="assets/images/demoes/demo7/products/product-5.jpg" width="175" height="175" alt="product" />
                                <img src="assets/images/demoes/demo7/products/product-5-2.jpg" width="175" height="175" alt="product" />
                            </a>
                        </figure>
                        <div class="product-details">
                            <div class="category-list">
                    ...
                    <div class="product-default left-details product-widget mb-2">
                        <figure>
                            <a href="demo7-product.html">
                                <img src="assets/images/demoes/demo7/products/product-1.jpg" width="175" height="175" alt="product" />
                                <img src="assets/images/demoes/demo7/products/product-1-2.jpg" width="175" height="175" alt="product" />
                            </a>
                        </figure>
                        <div class="product-details">
                            <div class="category-list">
            ...
            <div class="brands-slider owl-carousel owl-theme images-center appear-animate" data-animation-name="fadeIn" data-animation-delay="200" data-owl-options="{
					'margin': 0}">
                <img src="assets/images/brands/small/brand1.png" width="130" height="56" alt="brand">
                <img src="assets/images/brands/small/brand2.png" width="130" height="56" alt="brand">
                <img src="assets/images/brands/small/brand3.png" width="130" height="56" alt="brand">
                <img src="assets/images/brands/small/brand4.png" width="130" height="56" alt="brand">
                <img src="assets/images/brands/small/brand5.png" width="130" height="56" alt="brand">
                <img src="assets/images/brands/small/brand6.png" width="130" height="56" alt="brand">
            </div>
            <!-- End .brands-slider -->
        ...
        <div class="container">
            <div class="blog-section row">
                <div class="col-lg-6 appear-animate" data-animation-name="fadeInRightShorter" data-animation-delay="300">
                    ...
                    <article class="post d-sm-flex align-items-center mb-2 mb-lg-0">
                        <div class="post-media">
                            <a href="single.html">
                                <img src="assets/images/demoes/demo7/blog/shop7_post1.jpg" width="280" height="209" alt="Post">
                            </a>
                            <div class="post-date">
                ...
                <div class="col-lg-6 appear-animate" data-animation-name="fadeInRightShorter" data-animation-delay="100">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
                        <div class="widget widget-newsletter">
                            ...
                            <p class="mb-2 ls-0">Get all the latest information on events, sales and offers. Sign up for newsletter:
                            </p>
...
<!-- Mirrored from www.portotheme.com/html/porto_ecommerce/demo7.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Mar 2025 07:20:04 GMT -->
</html>